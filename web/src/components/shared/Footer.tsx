        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-6">
            ...
            <a
              ...
              className="flex items-center gap-1.5 text-zinc-600 hover:text-white transition-colors text-xs"
            >
            ...
            <a
              ...
              className="flex items-center gap-1.5 text-zinc-600 hover:text-amber-400 transition-colors text-xs"
            >
