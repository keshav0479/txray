...
export function AnimatedGlobe(_props: GraphicProps) {
  ...
  useEffect(() => {
    ...
    const globe = createGlobe(canvasRef.current, {
      ...
      mapSamples: 16000,
      mapBrightness: 2,
      baseColor: [0.12, 0.2, 0.45], // Blue-ish globe surface
      markerColor: [0.38, 0.65, 1.0], // Brighter, glowing blue markers
      glowColor: [0.06, 0.1, 0.3], // Dark blue glow
      markers: markerLocations.map((location, i) => ({
        location,
        size: 0.008 + Math.abs(Math.sin(i) * 0.006),
      })),
    });
    ...
    const animate = () => {
      ...
      globe.update({
        ...
        markers: markerLocations.map((location, i) => ({
          location,
          size: 0.008 + Math.abs(Math.sin(t + i * 0.8)) * 0.008,
        })),
      });
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
      <canvas
        ref={canvasRef}
        className="m-auto translate-x-3"
        width={600}
        height={600}
        style={{
          width: "100%",
...
export function AnimatedBlocks({ isPlaying }: GraphicProps) {
  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      <svg viewBox="0 0 350 140" className="w-full h-full" fill="none">
        {blocks.map((block, i) => {
          const x = 10 + i * 115;
            ...
            <g key={i}>
              ...
              <motion.rect
                ...
                transition={{
                  ...
                  times: [
                    0,
                    blockDelay / cycleDuration,
                    (blockDelay + 0.4) / cycleDuration,
                    0.65,
                    0.75,
                    0.85,
                    0.92,
              ...
              {[78, 90, 102].map((lineY, li) => (
                <motion.line
                  ...
                  transition={{
                    ...
                    times: [
                      0,
                      (blockDelay + 0.3 + li * 0.15) / cycleDuration,
                      (blockDelay + 0.6 + li * 0.15) / cycleDuration,
                      0.65,
                      0.75,
                      0.85,
                      0.92,
              ...
              {i < 2 && (
                <motion.g
                  ...
                  transition={{
                    ...
                    times: [
                      0,
                      (blockDelay + 0.8) / cycleDuration,
                      (blockDelay + 1.0) / cycleDuration,
                      (blockDelay + 1.4) / cycleDuration,
                      0.75,
                      0.85,
                      0.92,
                      1,
        ...
        >
          ...
          >
            <motion.rect
              ...
              transition={{
                duration: cycle,
                times: [0, 0.4, 0.41, 0.75, 1],
                repeat: Infinity,
              }}
            />
            {/* Block lock icon or hash target */}
            <motion.text
              x={targetBlock.x + targetBlock.w / 2}
              y={targetBlock.y + 30}
              textAnchor="middle"
              fill="#93c5fd"
              fontSize="20"
            ...
            <motion.text
              ...
              initial={{ opacity: 0 }}
              animate={
                isPlaying ? { opacity: [0, 0, 1, 1, 0] } : { opacity: 0 }
              }
              transition={{
                duration: cycle,
                times: [0, 0.4, 0.41, 0.9, 0.91],
                repeat: Infinity,
              }}
            >
              #c9a2
          ...
          <motion.line
            ...
            initial={{ opacity: 0 }}
            animate={
              isPlaying ? { opacity: [0, 0, 0, 1, 1, 0] } : { opacity: 0 }
            }
            transition={{
              duration: cycle,
              times: [0, 0.75, 0.85, 0.9, 0.91, 1],
              repeat: Infinity,
            }}
          />
      ...
      <svg viewBox="0 0 340 240" className="w-full h-full" fill="none">
        <defs>
          ...
          <clipPath id="hex-clip">
            <motion.rect
              ...
              animate={
                isPlaying
                  ? { x: [0, 340, 340, 0], width: [340, 0, 0, 340] }
                  : {}
              }
              transition={{
                duration: cycle,
        ...
        <g clipPath="url(#ui-clip)">
          ...
          <rect
            ...
            strokeWidth="2"
          />
          <text x="35" y="45" fill="#f59e0b" fontSize="14" fontWeight="bold">
            Block Header
          </text>
          <text
            x="35"
            ...
            fontFamily="monospace"
          >
            Hash: 00000000000000000003b4...
          </text>
          <text x="35" y="80" fill="#93c5fd" fontSize="10">
            Version: 4 • Time: 2024-05-12 14:30:00
          </text>
          ...
          <rect
            ...
            strokeDasharray="4 4"
          />
          <text x="30" y="125" fill="#fff" fontSize="12" fontWeight="bold">
            Tx 1{" "}
            <tspan fill="#f59e0b" fontWeight="normal">
              (Coinbase)
            </tspan>
          </text>
          <text x="30" y="145" fill="#60a5fa" fontSize="10">
            Reward: 3.125 BTC
          </text>
          ...
          <rect
            ...
            strokeDasharray="4 4"
          />
          <text x="190" y="125" fill="#fff" fontSize="12" fontWeight="bold">
            Tx 2
          </text>
          <text x="190" y="145" fill="#60a5fa" fontSize="10">
            Value: 0.50 BTC
          </text>
          ...
          <rect
            ...
            strokeWidth="1"
          />
          <text x="30" y="193" fill="#3b82f6" fontSize="10">
            Tx 3 ...
          </text>
          ...
          <rect
            ...
            strokeWidth="1"
          />
          <text x="190" y="193" fill="#3b82f6" fontSize="10">
            Tx 4 ...
          </text>
        </g>
        ...
        >
          ...
          <rect x="-40" y="0" width="40" height="240" fill="url(#scanGlow)" />
        </motion.g>
