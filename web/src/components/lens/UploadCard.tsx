...
export function UploadCard({
  ...
  const [activeTab, setActiveTab] = useState<"demo" | "upload" | "paste">(
    "demo",
  );
            ...
            >
              <div className="text-center space-y-2">
                ...
                <p className="text-zinc-400 text-sm">
                  Run a live analysis on a pre-loaded Bitcoin block to see how
                  txray Lens decodes the raw bytes.
                </p>
              </div>
          ...
          {activeTab === "upload" && (
            ...
            >
              <div className="text-center space-y-2">
                ...
                <p className="text-zinc-400 text-sm">
                  Upload raw `.dat` files directly from your Bitcoin Core
                  `blocks/` directory.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4">
                  <div className="flex-1 space-y-1">
                    <label className="text-xs font-semibold text-zinc-400 uppercase tracking-wider ml-1">
                      REV File <span className="text-red-400">*</span>
                    </label>
                    <input
                      type="file"
                      accept=".dat"
                  ...
                  <div className="flex-1 space-y-1">
                    <label className="text-xs font-semibold text-zinc-400 uppercase tracking-wider ml-1">
                      XOR File <span className="text-red-400">*</span>
                    </label>
                    <input
                      type="file"
                      accept=".dat"
                ...
                <div className="min-h-10 mt-1">
                  ...
                  ) : (!blkFile || !revFile || !xorFile) &&
                    (blkFile || revFile || xorFile) ? (
                    <p className="text-xs text-amber-400">
                      All three files (BLK, REV, XOR) are required by the CLI.
                    </p>
                  ) : null}
                </div>
              </div>
          ...
          {activeTab === "paste" && (
            ...
            >
              <div className="text-center space-y-2">
                ...
                <h3 className="text-xl font-semibold text-white">
                  Paste Transaction Fixture
                </h3>
                <p className="text-zinc-400 text-sm">
                  Paste a JSON fixture with{" "}
                  <code className="text-lens-400">raw_tx</code> and{" "}
                  <code className="text-lens-400">prevouts</code> to analyze a
                  single transaction.
                </p>
              </div>
              ...
              <button
                onClick={() => {
                  if (fixtureJson.trim()) onAnalyzeFixture(fixtureJson.trim());
                }}
